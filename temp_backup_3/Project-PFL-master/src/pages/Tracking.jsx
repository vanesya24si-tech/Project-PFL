...
import { getAllTransactions } from "../utils/customerStorage";
...
export default function Tracking() {
  ...
  // State data tracking laundry (gunakan transaksi dari CRM jika tersedia)
  const initialTracks = getAllTransactions();
  const [tracks, setTracks] = useState(initialTracks.length > 0 ? initialTracks : [
    { id: "ORD-001", user: "Andi Saputra", status: "Lagi Dicuci", detail: "Masuk mesin cuci nomor 04, pakai deterjen khusus warna.", currentStep: 1, eta: "14:30", weight: "5 Kg", service: "Express Kiloan", price: 50000, isPaid: true },
    { id: "ORD-002", user: "Siti Rahmawati", status: "Antre di Rak", detail: "Menunggu giliran mesin cuci kosong. Pisahkan baju luntur.", currentStep: 0, eta: "18:00", weight: "4.5 Kg", service: "Reguler Cuci Setrika", price: 36000, isPaid: true },
    { id: "ORD-003", user: "Budi Santoso", status: "Tahap Setrika", detail: "Lagi disetrika uap biar licin dan rapi.", currentStep: 2, eta: "17:00", weight: "3 Kg", service: "Reguler Setrika Saja", price: 18000, isPaid: false },
  ]);
