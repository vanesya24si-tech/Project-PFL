              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" defaultValue="Netto Express Central" className="w-full p-4 bg-slate-50 border border-transparent rounded-2xl focus:bg-white focus:border-blue-200 focus:outline-none text-sm font-bold transition-all" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">WhatsApp Official</label>
                    <input type="text" defaultValue="08123456789" className="w-full p-4 bg-slate-50 border border-transparent rounded-2xl focus:bg-white focus:border-blue-200 focus:outline-none text-sm font-bold transition-all" />
                  </div>
                  <div className="md:col-span-2 space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Alamat Lengkap</label>
                    <textarea rows="3" className="w-full p-4 bg-slate-50 border border-transparent rounded-2xl focus:bg-white focus:border-blue-200 focus:outline-none text-sm font-bold transition-all resize-none">Jl. Raya Industri No. 42, Jakarta Selatan</textarea>
                  </div>
                </div>

                <div className="pt-6 border-t border-slate-50">
                   <h3 className="text-sm font-black uppercase tracking-widest mb-4">Jam Operasional</h3>
                   <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                        <span className="text-[10px] font-black text-slate-500 uppercase">Buka</span>
                        <input type="time" defaultValue="08:00" className="bg-transparent text-sm font-black focus:outline-none" />
                      </div>
                      <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                        <span className="text-[10px] font-black text-slate-500 uppercase">Tutup</span>
                        <input type="time" defaultValue="21:00" className="bg-transparent text-sm font-black focus:outline-none" />
                      </div>
                   </div>
                </div>
              </div>
            ...
            {activeTab === "tarif" && (
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-sm font-black uppercase tracking-widest">Daftar Harga Layanan</h3>
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl hover:bg-slate-100/50 transition-all cursor-pointer group">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-sm font-black text-blue-600">Rp {item.price} <span className="text-[9px] text-slate-400">{item.unit}</span></span>
            ...
            {activeTab === "notif" && (
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="p-6 bg-blue-50 rounded-[2rem] border border-blue-100 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-blue-700 uppercase mb-1">WhatsApp Automation</h4>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl">
                      <span className="text-sm font-bold text-slate-700">{notif.label}</span>
