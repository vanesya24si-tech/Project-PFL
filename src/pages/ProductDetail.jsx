...
export default function ProductDetail() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.error("Gagal mengupdate detail produk:", err);
    ...
    return (
      <div className="min-h-screen bg-transparent p-6 flex items-center justify-center font-sans antialiased text-[#0F172A]">
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl p-10 max-w-md w-full text-center">
          ...
          <h2 className="text-base font-black text-slate-800 uppercase tracking-wider mb-2">Produk Tidak Ditemukan</h2>
          ...
          <Link
            to="/products"
            className="inline-flex items-center justify-center text-sm font-black bg-blue-600 hover:bg-blue-700 text-white px-6 py-4 rounded-2xl shadow-md shadow-blue-100 transition-all active:scale-95 w-full uppercase tracking-wider"
          >
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xs p-6 md:p-8 relative overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-6 mb-6">
            ...
            <div className="flex flex-col sm:items-end gap-3">
              ...
              <div className="text-right sm:text-right shrink-0">
                ...
                <span className="inline-block mt-1 font-black text-sm text-blue-600 bg-blue-50/50 px-3 py-1 rounded-xl border border-blue-100/60 font-mono">
                  {product.code}
                </span>
              </div>
            </div>
          ...
          {isEditing && (
            <form onSubmit={handleSubmit} className="mb-6 rounded-3xl border border-blue-100 bg-blue-50/40 p-5 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label className="space-y-2 text-sm font-semibold text-slate-600">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-base font-medium text-slate-700 outline-none transition focus:border-blue-400"
                  />
                </label>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-4 py-2.5 text-base font-black uppercase tracking-wider text-white transition-all hover:bg-blue-700"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-base font-black uppercase tracking-wider text-slate-600 transition-all hover:bg-slate-50"
                >
                  <HiX size={14} /> Batal
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            <div className="lg:col-span-7 rounded-3xl border border-slate-50 bg-slate-50/40 p-6 space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1 text-sm font-bold">
              ...
              <div className="rounded-3xl bg-blue-600 p-6 text-white shadow-md shadow-blue-100 relative overflow-hidden">
                <div className="relative z-10 space-y-1">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-base font-black text-blue-200">Rp</span>
