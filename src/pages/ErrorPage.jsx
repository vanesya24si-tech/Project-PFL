      ...
      <div className="relative text-center max-w-md z-10 flex flex-col items-center">
        ...
        {image ? (
          ...
          <div className="relative mb-6">
            ...
            {/* Foreground Number */}
            <div className="absolute inset-0 flex items-center justify-center text-6xl sm:text-7xl font-black text-rose-600 drop-shadow-sm">
              {code}
            </div>
            {/* Laundry Icon Accent */}
            <div className="absolute -top-4 -right-4 w-12 h-12 bg-white rounded-2xl shadow-lg flex items-center justify-center text-3xl animate-bounce">
              🧺
            </div>
          </div>
        )}
