    ...
    <div className="flex relative items-center justify-center min-h-[80vh] px-6 overflow-hidden">
      ...
      <div className="relative text-center max-w-md z-10 flex flex-col items-center">
        ...
        <div className="relative mb-2">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-6xl sm:text-7xl font-extrabold text-[#2c3619]">
            404
          </div>
        </div>

        {/* Judul & Deskripsi */}
        <h2 className="text-3xl font-bold text-[#2c3619] tracking-tight">
          Oops! Salah Alamat
        </h2>
