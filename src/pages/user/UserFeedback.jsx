...
export default function UserFeedback() {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-10 text-center space-y-4">
        ...
        <div className="relative">
          <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl flex items-center justify-center shadow-sm animate-bounce">
            <HiCheckCircle size={36} className="text-white" />
          </div>
          {/* Glow ring */}
          <div className="absolute inset-0 rounded-2xl bg-emerald-400/20 blur-xl -z-10 animate-pulse" />
        </div>

        <div className="bg-white/80 rounded-2xl border border-slate-200 shadow-sm px-8 py-6 max-w-xs w-full">
        ...
        <button
          ...
          className="px-8 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-400 text-white text-sm font-black rounded-2xl shadow-lg shadow-emerald-500/25 hover:-translate-y-0.5 hover:shadow-xl transition-all active:scale-95 uppercase tracking-widest"
        >
          Kirim Ulasan Lagi
        </button>
      </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative overflow-hidden rounded-2xl p-4 bg-gradient-to-br from-amber-500 via-orange-400 to-yellow-400 shadow-sm">
        {/* Decorative blobs */}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-white/80 rounded-2xl border border-slate-200 shadow-sm p-4">
          ...
          <textarea
            ...
            className="w-full px-4 py-2.5 text-sm bg-slate-50/80 border border-slate-200 rounded-2xl font-medium text-slate-700 placeholder:text-slate-300 focus:border-amber-400 outline-none resize-none transition-all"
          />
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full flex items-center justify-center gap-2 py-2.5 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-400 text-white text-sm font-black uppercase tracking-widest shadow-lg shadow-amber-500/20 hover:-translate-y-0.5 hover:shadow-xl transition-all active:scale-95 disabled:opacity-60"
        >
          {submitting ? (
