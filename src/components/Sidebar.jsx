...
export default function Sidebar({ collapsed }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center text-white font-black text-xl shadow-md shadow-blue-100 shrink-0">
          N
        </div>
        {!collapsed && (
          <span className="text-2xl font-black tracking-tight text-slate-800 italic uppercase">
        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {!collapsed && (
                <span className="text-sm tracking-wide flex-1 whitespace-nowrap">
                  {item.label}
                </span>
              )}
      ...
      {!collapsed && (
        <div className="mt-auto bg-gradient-to-br from-blue-600 to-blue-700 rounded-[1.5rem] p-4 text-white relative overflow-hidden shadow-lg shadow-blue-100 border border-blue-500/10">
          <div className="relative z-10 space-y-2">
            ...
            <div>
              <p className="text-sm font-black tracking-wide">Keamanan Data</p>
