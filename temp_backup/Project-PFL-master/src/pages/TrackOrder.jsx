    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC]">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Memuat status laundry...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] p-6">
        <div className="text-center max-w-sm bg-white border border-dashed border-slate-300 rounded-3xl p-8 space-y-3">
          <HiExclamationCircle className="text-4xl text-slate-300 mx-auto" />
          <h1 className="text-lg font-black text-slate-800">Nota Tidak Ditemukan</h1>
          ...
          <Link to="/" className="inline-block text-xs font-black text-blue-600 uppercase tracking-wide">
            Kembali ke Beranda
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#F8FAFC] p-4 md:p-8 flex items-center justify-center">
      <div className={`w-full max-w-lg rounded-3xl border-2 ${themeStyles.border} ${themeStyles.bg} p-6 md:p-8 shadow-sm`}>
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          <div className={`w-16 h-16 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center justify-center text-3xl ${themeStyles.icon}`}>
          ...
          <h2 className="text-xl font-black text-slate-800 uppercase tracking-tight text-center">{order.user}</h2>
          <p className={`text-lg font-black ${themeStyles.icon}`}>{order.status}</p>
        </div>
        ...
        <div className="bg-white/90 p-4 rounded-2xl border border-slate-200/80 space-y-2 mb-6">
          ...
          {order.detail && (
            <p className="text-xs italic text-slate-500 pt-2 border-t border-slate-100">"{order.detail}"</p>
          )}
          {order.eta && (
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="w-full flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xs py-3 rounded-2xl transition-all"
        >
