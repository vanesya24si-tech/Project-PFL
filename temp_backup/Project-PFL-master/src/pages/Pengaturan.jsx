  ...
  return (
    <div className="p-8 bg-[#F4F7F6] min-h-screen font-sans">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-black text-[#1A2E35] mb-8">Pengaturan Sistem</h1>
            ...
            <div className="bg-white rounded-[2.5rem] border border-[#E0EEEA] shadow-sm p-8 md:p-10">
              ...
              {activeTab === "umum" && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                  <h2 className="text-xl font-black text-[#1A2E35] mb-6">Informasi Toko</h2>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-xs font-black uppercase text-slate-400">Nama Laundry</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-black uppercase text-slate-400">Nomor WhatsApp</label>
              ...
              {activeTab === "operasional" && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                  <h2 className="text-xl font-black text-[#1A2E35] mb-6">Biaya & Logistik</h2>
                  
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-[#E0EEEA]">
                      <div className="flex items-center gap-3">
                        <HiCurrencyDollar className="text-[#1ABC9C] text-2xl" />
                        <div>
                          <p className="font-bold text-[#1A2E35]">Biaya Antar-Jemput</p>
                          <p className="text-xs text-slate-500">Biaya flat per transaksi logistik</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-[#E0EEEA]">
                      <div className="flex items-center gap-3">
                        <HiLocationMarker className="text-[#1ABC9C] text-2xl" />
                        <div>
                          <p className="font-bold text-[#1A2E35]">Radius Maksimal</p>
                          <p className="text-xs text-slate-500">Jangkauan kurir (Km)</p>
                        </div>
                      </div>
              ...
              {activeTab === "keamanan" && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                  <h2 className="text-xl font-black text-[#1A2E35] mb-6">Akses & Sandi</h2>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-xs font-black uppercase text-slate-400">Kata Sandi Saat Ini</label>
                      <input type="password" placeholder="••••••••" className="w-full px-5 py-3 bg-slate-50 border border-[#E0EEEA] rounded-xl outline-none" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-black uppercase text-slate-400">Kata Sandi Baru</label>
              ...
              <div className="mt-10 pt-8 border-t border-slate-100">
                <button className="flex items-center justify-center gap-2 w-full md:w-auto md:px-10 py-4 bg-[#1ABC9C] text-white font-black rounded-2xl shadow-xl shadow-[#1ABC9C]/20 hover:bg-[#16A085] transition-all active:scale-95 uppercase tracking-widest text-xs">
                  <HiSave className="text-lg" /> Simpan Perubahan
                </button>
              </div>
