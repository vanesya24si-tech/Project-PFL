        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-[2.5rem] shadow-xl shadow-blue-900/5 border border-blue-50">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            ...
            <button
              type="button"
              onClick={openAddForm}
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-blue-600 px-5 py-4 text-sm font-black uppercase tracking-wider text-white shadow-lg shadow-blue-600/20 transition-all hover:bg-blue-700"
            >
              <HiPlus className="text-base" /> Tambah Produk
            </button>
          </div>
        </div>
          ...
          <div className="bg-white rounded-[2.5rem] border border-blue-100 p-6 shadow-sm">
            <div className="flex items-center justify-between gap-4 mb-5">
              <div>
                ...
                <h2 className="text-xl font-black text-slate-900">{editingProductId ? "Edit Produk" : "Tambah Produk Baru"}</h2>
              </div>
              <button
                type="button"
                onClick={resetForm}
                className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-600 transition-all hover:bg-slate-50"
              >
                <HiX size={16} /> Tutup
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className="space-y-2 text-xs font-semibold text-slate-600">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700 outline-none transition focus:border-blue-400 focus:bg-white"
                />
              </label>
              ...
              <div className="md:col-span-2 flex flex-wrap gap-3 pt-2">
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-5 py-3 text-sm font-black uppercase tracking-wider text-white transition-all hover:bg-blue-700"
                >
                ...
                <button
                  type="button"
                  onClick={resetForm}
                  className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-black uppercase tracking-wider text-slate-600 transition-all hover:bg-slate-50"
                >
                  <HiX size={16} /> Batal
                </button>
              </div>
        ...
        <div className="flex items-center gap-4 bg-blue-600 p-6 rounded-3xl text-white overflow-hidden relative">
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium">Semua perubahan produk tersimpan secara lokal di browser Anda.</p>
            </div>
          </div>
